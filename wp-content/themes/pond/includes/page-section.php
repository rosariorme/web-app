...
?>
        ...
        <?php if (($templatename == 'template-onepage.php' && $post->post_content !== "") || $templatename !== 'template-onepage.php') { ?>
		<!-- SECTION -->
		<section id="section-<?php echo esc_attr($post->post_name); ?>" class="<?php echo esc_attr($pTop); ?>">
          	<div class="section-inner"> 
				...
				if (!$templatename && $templatename =='' || ($templatename == 'template-onepage.php')) {
					
					// -----------------------------------
					// DEFAULT SECTION
					// -----------------------------------
					
					if ($templatename !== 'template-onepage.php') { get_template_part( 'includes/page-title' ); }
					echo '<div class="wrapper">';
					the_content(); 
					echo '</div>';
				} else if ($templatename == 'template-portfolio.php') {
					...
					if ($category[0] == '') { $allCatsTmp = get_terms( 'portfolio_category'); $category = array(); foreach ($allCatsTmp as $c) { $category[] = $c->slug;} }
					...
					if ($portfolioType == 'split') { 
					// SPLIT SECTION // ?>
                    <div id="portfolio-split" class="split-section clearfix" style="background:<?php echo $splitColor; ?>;">
					...
					if (isset($content) && $content !== '') { echo '<div class="wrapper">'.$content.'</div>'; }
